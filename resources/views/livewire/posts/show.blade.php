                        ...
                        <div>
                            @if($post->comments->count() < 1)
                                ...
                                <button wire:click="delete"
                                        ...
                                        class="inline-flex items-center justify-center h-8 gap-2 px-4 text-xs font-medium tracking-wide text-white transition duration-300 rounded-full focus-visible:outline-none whitespace-nowrap bg-brand-500 hover:bg-brand-600 focus:bg-brand-700 disabled:cursor-not-allowed disabled:border-brand-300 disabled:bg-brand-300 disabled:shadow-none">
                                    <span>Delete</span>
                                </button>
